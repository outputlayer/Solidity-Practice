...
contract Shower {
    ...
    address public tokenContractAddress = 0xbF4046E0366706bDF2E1B69f876156CEd8c59710;
    ...
    for (uint256 i = 0; i < n; i++) {
        uint index = i % 2; // 0 for even i, 1 for odd i, uint index = i % 5;
